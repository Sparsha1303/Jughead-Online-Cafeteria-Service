...
var stripeModuleNextUrl = stripeFormModule.attr("next_url")
...
if (paymentForm.length > 1){
    alert("Only one payment form allowed per user")
...
function redirectToNext(nextPath,timeoffest){
...
//function to handle stripe token error
